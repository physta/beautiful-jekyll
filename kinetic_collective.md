...
<center>&kappa; = (&Sigma; - 1)&kappa;<sub>K</sub> + &Sigma;&kappa;<sub>C</sub> ,</center> <right>(1)</right>
...
<center>&ell;<sup>2</sup> = (&Sigma; - 1)&ell;<sup>2</sup><sub>K</sub> + &Sigma;&ell;<sup>2</sup><sub>C</sub> .</center>

This generalization of the Guyer and Krumhansel equation done in the KCM framework leads to the so-called hydrodynamic KCM equation.
